...
/**
 * $Id: DestroyMessage.java,v 1.2 2000/11/15 19:54:20 wohlever Exp $
 */
 ...
 * <b>GAL_DESTROY_MSG_TYPE</b>.
 *
 * @author Sasha P. Caskey
 * @see galaxy.lang.GalaxyMessage
 * @see galaxy.lang.Clause
 */
public class DestroyMessage extends GalaxyMessage {

    public DestroyMessage(Object data) {
	this.data = data;
	msgType = GAL_DESTROY_MSG_TYPE;
    }
}
